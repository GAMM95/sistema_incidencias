<div class="pcoded-main-container mt-5">
  <div class="pcoded-content">
    ...
    <form id="formConsultarAsignaciones" action="consultar-asignaciones.php?action=consultar" method="GET" class="card table-card  bg-white shadow-md p-6 w-full text-xs mb-2">
      <div class="flex flex-wrap -mx-2 justify-center">
        <!-- BUSCAR POR USUARIO-->
        <div class="w-full md:w-1/3 px-2 mb-2">
          <label for="usuarioAsignado" class="block mb-1 font-bold text-xs">Usuario asignado:</label>
          <select id="usuarioAsignado" name="usuarioAsignado" class="border p-2 w-full text-xs cursor-pointer">
          </select>
        </div>
    ...
    <div class="relative shadow-md sm:rounded-lg">
      <div class="relative overflow-x-hidden shadow-md sm:rounded-lg">
        <table id="tablaIncidenciasMantenimiento" class="w-full text-xs text-left rtl:text-right text-gray-500 bg-white">
