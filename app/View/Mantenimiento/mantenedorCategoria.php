        ...
        <form id="formCategoria" action="modulo-categoria.php?action=registrar" method="POST" class="card table-card bg-white shadow-md p-6 w-full text-xs">
          ...
          <div class="flex flex-wrap -mx-2">
            <div class="w-full px-2 mb-3">
              ...
              <input type="text" id="nombreCategoria" name="nombreCategoria" class="border p-2 w-full text-xs rounded-md" pattern="[A-Za-z\s]+" placeholder="Ingrese nueva categor&iacute;a" oninput="capitalizeInput(this)">
            </div>
          </div>

          <!-- Botones del fomulario -->
          <div class="flex justify-center space-x-4">
            <button type="submit" id="guardar-categoria" class="bn btn-primary text-xs text-white font-bold py-2 px-3 rounded-md disabled:bg-gray-300 disabled:cursor-not-allowed"><i class="feather mr-2 icon-save"></i>Registrar</button>
            <button type="button" id="editar-categoria" class="bn btn-info text-xs text-white font-bold py-2 px-3 rounded-md disabled:bg-gray-300 disabled:cursor-not-allowed" disabled><i class="feather mr-2 icon-edit"></i>Actualizar</button>
        ...
        <div class="relative overflow-x-hidden shadow-md sm:rounded-lg">
          <table id="tablaCategorias" class="w-full text-xs text-left rtl:text-right text-gray-500 cursor-pointer bg-white">
            ...
            <tbody>
              ...
              <?php else: ?>
                <tr>
                  <td colspan="5" class="text-center py-3">No se han registrado nuevas categor&iacute;as.
                </tr>
              <?php endif; ?>
            </tbody>
