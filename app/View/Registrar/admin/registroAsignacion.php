    ...
    <form id="formAsignacion" action="registro-asignacion.php?action=registrar" method="POST" class="card table-card bg-white shadow-md p-4 w-full text-xs mb-3">
      ...
      <div class="flex flex-wrap -mx-2 justify-center">
        ...
        <div class="flex justify-center items-center space-x-4 mt-3 ml-5">
          ...
          <button type="button" id="editar-asignacion" class="bn btn-info text-xs text-white font-bold py-2 px-3 rounded-md disabled:bg-gray-300 disabled:cursor-not-allowed" disabled><i class="feather mr-2 icon-edit"></i>Actualizar</button>
