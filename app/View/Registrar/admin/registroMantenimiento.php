    ...
    <div class="w-full">
      ...
      <div class="relative max-h-[500px] overflow-x-hidden shadow-md sm:rounded-lg">
        <table id="tablaIncidenciasMantenimiento" class="w-full text-xs text-left rtl:text-right text-gray-500 cursor-pointer bg-white">
          ...
          <!-- Cuerpo de la tabla -->
          <tbody>
            <?php if (!empty($resultadoMantenimiento)) : ?>
              <?php foreach ($resultadoMantenimiento as $mantenimiento) : ?>
                ...
                <tr class='second-table hover:bg-green-100 hover:scale-[101%] transition-all border-b' data-id="<?= $numeroAsignacion; ?>">
                  ...
                  <th scope='row' class='px-6 py-3 font-medium text-gray-900 whitespace-nowrap hidden'><?= $mantenimiento['REC_numero']; ?></th>
                  <td class='px-6 py-2 text-center'><?= $mantenimiento['INC_numero_formato']; ?></td>
                  <td class='px-6 py-2 text-center'><?= $mantenimiento['ARE_nombre']; ?></td>
                  <td class='px-6 py-2 text-center'><?= $mantenimiento['INC_asunto']; ?></td>
                  <td class='px-6 py-2 text-center'><?= $mantenimiento['INC_codigoPatrimonial']; ?></td>
                  <td class='px-6 py-2 text-center'><?= $mantenimiento['BIE_nombre']; ?></td>
                  <td class='px-6 py-2 text-center'><?= $mantenimiento['fechaAsignacionFormateada']; ?></td>
                  <td class='px-6 py-2 text-center'><?= $mantenimiento['fechaMantenimientoFormateada']; ?></td>
                  <td class='px-6 py-2 text-center'><?= $mantenimiento['usuarioSoporte']; ?></td>
