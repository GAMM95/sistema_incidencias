...
$('#reporteEventosRecepcionesFecha').click(function () {
  ...
  if (!validarCamposEventosRecepcionesFecha()) {
  ...
  $.ajax({
    url: 'ajax/ReportesAuditoria/EventosIncidencias/Recepciones/getReporteAuditoriaRecepcionesFecha.php',
    method: 'GET',
    data: {
    ...
    success: function (data) {
      ...
      try {
        if (data.length > 0) {
          ...
          doc.setProperties({
            title: 'Reporte de eventos de recepciones por rango de fechas.pdf'
          });

          // Mostrar mensaje de éxito
          toastr.success('Reporte de eventos de recepciones por rango de fechas generado.', 'Mensaje');
          ...
          toastr.warning('No se ha encontrado eventos de recepciones por rango de fechas generado.', 'Advertencia');
        }
      } catch (error) {
...
function validarCamposEventosRecepcionesFecha() {
  var valido = false;
  var mensajeError = '';
