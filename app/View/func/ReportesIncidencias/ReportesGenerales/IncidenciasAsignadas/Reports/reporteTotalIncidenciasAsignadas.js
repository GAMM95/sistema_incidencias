...
$('#reporteIncidenciasAsignadas').click(function () {

  // Realziar la solicitud AJAX para obtener los datos de la incidencia
  $.ajax({
    url: 'ajax/ReportesIncidencias/ReportesGenerales/IncidenciasAsignadas/getReporteIncidenciasAsignadasTotales.php',
    method: 'GET',
    dataType: 'json',
    success: function (data) {
      ...
      try {
        ...
        function addHeader(doc, totalRecords) {
          ...
          const reportTitle = 'REPORTE TOTAL DE INCIDENCIAS ASIGNADAS';
        ...
        doc.autoTable({
          ...
          head: [['N°', 'INCIDENCIA', 'ÁREA SOLICITANTE', 'ASUNTO', 'EQUIPO', 'NOMBRE DEL BIEN', 'FECHA DE ASIGNACIÓN', 'FECHA DE FINALIZACIÓN', 'USUARIO ASIGNADO', 'TIEMPO DE MANTENIMIENTO', 'ESTADO']],
    ...
    error: function (xhr, status, error) {
      toastr.error('Hubo un error al obtener el reporte de las incidencias asignadas.', 'Mensaje de error');
