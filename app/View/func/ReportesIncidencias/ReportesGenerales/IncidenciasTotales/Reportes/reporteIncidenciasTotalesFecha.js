...
$('#reporteIncidenciasTotalesFecha').click(function () {
  const fechaInicio = $('#fechaInicio_incidencias_totales').val();
  const fechaFin = $('#fechaFin_incidencias_totales').val();
  ...
  $.ajax({
    url: 'ajax/ReportesAuditoria/EventosTotales/getReporteIncidenciasTotalesFecha.php',
    method: 'GET',
    ...
    success: function (data) {
      ...
      try {
        if (data.length > 0) {
          ...
          const fechaInicioOriginal = $('#fechaInicio_incidencias_totales').val();
          const fechaFinOriginal = $('#fechaFin_incidencias_totales').val();
          ...
          setTimeout(() => {
            ...
            $('#fechaInicio_incidencias_totales').val('');
            $('#fechaFin_incidencias_totales').val('');
          }, 2000);
        } else {
