...
$('#reporteEquiposAfectados').click(function () {

  // Realizar una solicitud AJAX para obtener los datos del cierre de incidencia
  $.ajax({
    url: 'ajax/ReportesIncidencias/ReportesOtros/EquiposAfectados/getReporteTotalEquipoMasAfectado.php',
    method: 'GET',
    dataType: 'json',
    success: function (data) {
      ...
      try {
        ...
        function addHeader(doc, totalRecords) {
          ...
          const reportTitle = 'REPORTE TOTAL EQUIPOS AFECTADOS';
