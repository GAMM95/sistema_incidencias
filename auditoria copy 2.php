...
function generarTablaEventos($resultado, $itemCount)  {
  $html = '';
  if (!empty($resultado)) {
    foreach ($resultado as $item) {
      ...
      $html .= '<td class="px-3 py-2 text-center">' . htmlspecialchars($item['AUD_operacion']) . '</td>';
    ...
    $html = '<tr><td colspan="9" class="text-center py-3">No se encontraron registros.</td></tr>';
  }
  return $html; 
}
