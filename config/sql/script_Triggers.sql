...
-------------------------------------------------------------------------------------------------------
-- FUNCION PARA GENERAR EL NUMERO DE INCIDENCIA 0000-A�O-MDE
...
BEGIN
    ...
    -- Obtener el �ltimo n�mero de incidencia del a�o actual
    ...
    -- Generar el formato con el n�mero actual
...
BEGIN
    ...
    -- Obtener el �ltimo n�mero de recepci�n
