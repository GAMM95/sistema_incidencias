...
$('#reporteEventosFecha').click(function () {
  ...
  if (!validarCamposEventosIncidenciasFecha()) {
  ...
  $.ajax({
    url: 'ajax/ReportesAuditoria/EventosIncidencias/Incidencias/getReporteAuditoriaIncidenciasFecha.php',
    method: 'GET',
    data: {
    ...
    success: function (data) {
      ...
      try {
        if (data.length > 0) {
          ...
          doc.setProperties({
            title: 'Reporte de eventos de incidencias por rango de fechas.pdf'
          });

          // Mostrar mensaje de éxito
          toastr.success('Reporte de eventos de incidencias por rango de fechas generado.', 'Mensaje');
          ...
          toastr.warning('No se ha encontrado eventos de incidencias por rango de fechas generado.', 'Advertencia');
        }
      } catch (error) {
...
function validarCamposEventosIncidenciasFecha() {
  var valido = false;
  var mensajeError = '';
