...
$('#reporteEventosAreasFecha').click(function () {
  ...
  if (!validarCamposEventosAreasFecha()) {
  ...
  $.ajax({
    url: 'ajax/ReportesAuditoria/EventosMantenedores/Areas/getReporteAuditoriaAreasFecha.php',
    method: 'GET',
    data: {
    ...
    success: function (data) {
      ...
      try {
        if (data.length > 0) {
          ...
          toastr.success('Reporte de eventos de &aacute;reas por rango de fechas generado.', 'Mensaje');
          ...
          toastr.warning('No se ha encontrado eventos de &aacute;reas por rango de fechas generado.', 'Advertencia');
        }
      } catch (error) {
...
function validarCamposEventosAreasFecha() {
  var valido = false;
  var mensajeError = '';
