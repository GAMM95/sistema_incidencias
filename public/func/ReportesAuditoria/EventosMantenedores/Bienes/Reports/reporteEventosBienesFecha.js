...
$('#reporteEventosBienesFecha').click(function () {
  ...
  if (!validarCamposEventosBienesFecha()) {
  ...
  $.ajax({
    url: 'ajax/ReportesAuditoria/EventosMantenedores/Bienes/getReporteAuditoriaBienesFecha.php',
    method: 'GET',
    data: {
    ...
    success: function (data) {
      ...
      try {
        if (data.length > 0) {
          ...
          doc.setProperties({
            title: 'Reporte de eventos de áreas por rango de fechas.pdf'
          });

          // Mostrar mensaje de éxito
          toastr.success('Reporte de eventos de bienes por rango de fechas generado.', 'Mensaje');
          ...
          toastr.warning('No se ha encontrado eventos de bienes por rango de fechas generado.', 'Advertencia');
        }
      } catch (error) {
...
function validarCamposEventosBienesFecha() {
  var valido = false;
  var mensajeError = '';
