...
$('#reporteEventosCategoriasFecha').click(function () {
  ...
  if (!validarCamposEventosCategoriasFecha()) {
  ...
  $.ajax({
    url: 'ajax/ReportesAuditoria/EventosMantenedores/Categorias/getReporteAuditoriaCategoriasFecha.php',
    method: 'GET',
    data: {
    ...
    success: function (data) {
      ...
      try {
        if (data.length > 0) {
          ...
          doc.setProperties({
            title: 'Reporte de eventos de categorías por rango de fechas.pdf'
          });

          // Mostrar mensaje de éxito
          toastr.success('Reporte de eventos de categor&iacute;as por rango de fechas generado.', 'Mensaje');
          ...
          toastr.warning('No se ha encontrado eventos de categor&iacute;as por rango de fechas generado.', 'Advertencia');
        }
      } catch (error) {
...
function validarCamposEventosCategoriasFecha() {
  var valido = false;
  var mensajeError = '';
