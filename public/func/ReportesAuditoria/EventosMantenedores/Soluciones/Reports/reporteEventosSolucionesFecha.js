...
$('#reporteEventosSolucionesFecha').click(function () {
  ...
  if (!validarCamposEventosSolucionesFecha()) {
  ...
  $.ajax({
    url: 'ajax/ReportesAuditoria/EventosMantenedores/Soluciones/getReporteAuditoriaSolucionesFecha.php',
    method: 'GET',
    data: {
    ...
    success: function (data) {
      ...
      try {
        if (data.length > 0) {
          ...
          doc.setProperties({
            title: 'Reporte de eventos de soluciones por rango de fechas.pdf'
          });

          // Mostrar mensaje de éxito
          toastr.success('Reporte de eventos de soluciones por rango de fechas generado.', 'Mensaje');
          ...
          toastr.warning('No se ha encontrado eventos de soluciones por rango de fechas generado.', 'Advertencia');
        }
      } catch (error) {
...
function validarCamposEventosSolucionesFecha() {
  var valido = false;
  var mensajeError = '';
