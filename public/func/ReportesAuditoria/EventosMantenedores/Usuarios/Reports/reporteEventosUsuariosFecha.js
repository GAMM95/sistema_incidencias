...
$('#reporteUserEventosFecha').click(function () {
  ...
  if (!validarCamposEventosUsuariosFecha()) {
  ...
  $.ajax({
    url: 'ajax/ReportesAuditoria/EventosMantenedores/Usuarios/getReporteAuditoriaUsuariosFecha.php',
    method: 'GET',
    data: {
    ...
    success: function (data) {
      ...
      try {
        if (data.length > 0) {
          ...
          doc.setProperties({
            title: 'Reporte de eventos de usuarios por rango de fechas.pdf'
          });

          // Mostrar mensaje de éxito
          toastr.success('Reporte de eventos de usuarios por rango de fechas generado.', 'Mensaje');
          ...
          toastr.warning('No se ha encontrado eventos de usuarios por rango de fechas generado.', 'Advertencia');
        }
      } catch (error) {
...
function validarCamposEventosUsuariosFecha() {
  var valido = false;
  var mensajeError = '';
