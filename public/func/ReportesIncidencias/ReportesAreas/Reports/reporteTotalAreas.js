...
$('#reporteTotalAreas').click(function () {

  // Realziar la solicitud AJAX para obtener los datos de la incidencia
  $.ajax({
    url: 'ajax/ReportesIncidencias/ReportesAreas/getReporteTotalAreas.php',
    method: 'GET',
    dataType: 'json',
    success: function (data) {
      ...
      try {
        ...
        function addHeader(doc, totalRecords) {
          ...
          const reportTitle = 'REPORTE TOTAL DE ÁREAS';
    ...
    error: function (xhr, status, error) {
      toastr.error('Hubo un error al obtener el reporte total de áreas afectadas.', 'Mensaje de error');
