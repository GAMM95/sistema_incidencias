...
$('#reporteIncidenciasAsignadasUsuarioFecha').click(function () {
  const usuario = $("#usuarioIncidenciasAsignadas").val();
  ...
  if (!validarCamposIncidenciasAsignadasUsuarioFecha()) {
    return;
  }
  ...
  $.ajax({
    url: 'ajax/ReportesIncidencias/ReportesGenerales/IncidenciasAsignadas/getReporteIncidenciasAsignadasUsuarioFecha.php',
    method: 'GET',
    data: {
      usuarioIncidenciasAsignadas: usuario,
      ...
      try {
        if (data.length > 0) {
          ...
          function addHeader(doc, totalRecords) {
            ...
            const logoWidth = 25;
            const logoHeight = 25;
            const reportTitle = 'REPORTE DE INCIDENCIAS ASIGNADAS';
          ...
          function addUserAndDates(doc) {
            ...
            // Obtener valores
            const usuarioNombre = $('#nombreUsuarioIncidenciasAsignadas').val() || '-';
          ...
          function addTable(doc) {
            ...
            doc.autoTable({
              ...
              head: [['N°', 'INCIDENCIA', 'ÁREA SOLICITANTE', 'ASUNTO', 'EQUIPO', 'NOMBRE DEL BIEN', 'FECHA DE ASIGNACIÓN', 'FECHA DE FINALIZACIÓN', 'TIEMPO DE MANTENIMIENTO', 'ESTADO']],
              ...
              columnStyles: {
                ...
                2: { cellWidth: 38 }, // Ancho para la columna area solicitante
                3: { cellWidth: 38 }, // Ancho para la columna asunto
                ...
                8: { cellWidth: 40 }, // Ancho para la columna tiempo de mantenimiento
          ...
          doc.setProperties({
            title: "Reporte de incidencias asignadas por usuario y fechas.pdf"
          })
          // Mostrar mensaje de éxito
          toastr.success('Reporte de incidencias asignadas por usuario y fechas generado.', 'Mensaje');
...
function validarCamposIncidenciasAsignadasUsuarioFecha() {
  var valido = false;
  var mensajeError = '';
  ...
  var usuarioSeleccionado = ($('#usuarioIncidenciasAsignadas').val() !== null && $('#usuarioIncidenciasAsignadas').val().trim() !== '');
