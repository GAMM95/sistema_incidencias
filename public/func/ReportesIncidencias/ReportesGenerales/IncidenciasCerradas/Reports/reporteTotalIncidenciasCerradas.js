...
$('#reporteIncidenciasCerradas').click(function () {

  // Realziar la solicitud AJAX para obtener los datos de la incidencia
  $.ajax({
    url: 'ajax/ReportesIncidencias/ReportesGenerales/IncidenciasCerradas/getReporteIncidenciasCerradasTotales.php',
    method: 'GET',
    dataType: 'json',
    success: function (data) {
      ...
      try {
        ...
        function addHeader(doc, totalRecords) {
          ...
          const reportTitle = 'REPORTE TOTAL DE INCIDENCIAS CERRADAS';
    ...
    error: function (xhr, status, error) {
      toastr.error('Hubo un error al obtener el reporte de las incidencias cerradas.', 'Mensaje de error');
